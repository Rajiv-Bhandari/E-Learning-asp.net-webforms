        ...
        <div class="col-md-6">
            ...
            <div class="chart-container">
                <asp:Chart ID="Chart2" runat="server" DataSourceID="lessonstatus">
                    <Series>
                        <asp:Series Name="Series1" XValueMember="LESSON_STATUS" YValueMembers="STUDENT_COUNT" Color="Red">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
        ...
        <div class="col-md-6">
            ...
            <div class="chart-container">
                <asp:Chart ID="Chart3" runat="server" DataSourceID="courseinstructor">
                    <Series>
                        <asp:Series ChartType="Area" Name="Series1" XValueMember="INSTRUCTOR_NAME" YValueMembers="COURSE_COUNT" Color="Orange">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
         ...
         <div class="col-md-6">
            ...
            <div class="chart-container">
                <asp:Chart ID="Chart1" runat="server" DataSourceID="studentenrollment">
                    <Series>
                        <asp:Series ChartType="Line" Name="Series1" XValueMember="COURSE_TITLE" YValueMembers="ENROLL_COUNT" Color="Green">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
        ...
        <div class="col-md-6">
            ...
            <div class="chart-container">
                <asp:Chart ID="Chart4" runat="server" DataSourceID="query">
                    <Series>
                        <asp:Series ChartType="Point" Name="Series1" XValueMember="INSTRUCTOR_NAME" YValueMembers="QUERY_COUNT" Color="Blue">
                        </asp:Series>
                    </Series>
                    <ChartAreas>
                        <asp:ChartArea Name="ChartArea1">
